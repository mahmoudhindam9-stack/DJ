...
def fix_studio() -> None:
    ...
    if marker not in text:
        ...
        # Mutating track data must trigger recomposition so the live Studio reflects edits.
        replacements = [
        ...
        # Presets/progression change nested notes too.
        text = replace_once(
            text,
        ...
        # Respect the Loop toggle: ONE SHOT stops after the final bar.
        text = replace_once(
            text,
            '                    if (beat >= loopBeats) {\n                        beat %= loopBeats\n                    }',
            '                    if (beat >= loopBeats) {\n                        if (loopEnabled) {\n                            beat %= loopBeats\n                        } else {\n                            isPlaying = false\n                            break\n                        }\n                    }',
