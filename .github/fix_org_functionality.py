...
# Make recorder UI state observable and ensure the file reference updates when recording ends.
...
# Add a dedicated refresh/status action so the user can recover the live engine after returning to ORG.
...
print("ORG state and playback fixes applied")
